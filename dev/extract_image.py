...
class ExtractWindow(QWidget):
    ...
    def init_ui(self):
        ...
        image_info.addWidget(QLabel("image"))
        image_info.addWidget(meta_info)

        btn_save = QPushButton("extract images")
        ...
        main_vbox.addLayout(image_info)
        main_vbox.addWidget(QLabel(""))
        main_vbox.addWidget(QLabel("Images to extract"))
        main_vbox.addWidget(image_list)
